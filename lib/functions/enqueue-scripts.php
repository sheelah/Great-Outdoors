...
function great_outdoors_scripts() {
	...
	$font_base_url = 'https://fonts.googleapis.com/css';
	...
	wp_enqueue_style( 'great-outdoors-font-awesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css', array(), null );

	// Enqueue concatenated and minified JS
	wp_enqueue_script( 'picturefill', 'https://cdnjs.cloudflare.com/ajax/libs/picturefill/3.0.2/picturefill.min.js', array(), null );
