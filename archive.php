			...
			<header class="page-header">
				<h1 class="page-title">
					<?php
						...
						elseif ( is_day() ) :
							printf( __( 'Day: %s', 'great-outdoors' ), '<span>' . get_the_date() . '</span>' );

						elseif ( is_month() ) :
							printf( __( 'Month: %s', 'great-outdoors' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'great-outdoors' ) ) . '</span>' );

						elseif ( is_year() ) :
							printf( __( 'Year: %s', 'great-outdoors' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'great-outdoors' ) ) . '</span>' );
